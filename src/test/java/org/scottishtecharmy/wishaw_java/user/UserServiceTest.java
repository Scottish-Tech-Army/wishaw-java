...
class UserServiceTest {
    ...
    void create_success_defaultRole() {
        CreateUserRequest request = new CreateUserRequest("newuser", "pass123", "New User", null, null, null);
    ...
    void create_withCentreAndRole() {
        CreateUserRequest request = new CreateUserRequest("admin", "pass123", "Admin", "CENTRE_ADMIN", 1L, null);
    ...
    void create_duplicateUsername_throws() {
        CreateUserRequest request = new CreateUserRequest("john", "pass123", "John", null, null, null);
    ...
    void create_centreNotFound_throws() {
        CreateUserRequest request = new CreateUserRequest("newuser", "pass123", "New", null, 999L, null);
        when(userRepository.existsByUsername("newuser")).thenReturn(false);
        when(passwordEncoder.encode("pass123")).thenReturn("encoded");
    ...
    void update_roleAndCentre() {
        ...
        UpdateUserRequest request = new UpdateUserRequest(null, "MAIN_ADMIN", 2L, null);
        when(userRepository.findById(1L)).thenReturn(Optional.of(testUser));
    ...
    void update_notFound_throws() {
        UpdateUserRequest request = new UpdateUserRequest("X", null, null, null);
        when(userRepository.findById(99L)).thenReturn(Optional.empty());
