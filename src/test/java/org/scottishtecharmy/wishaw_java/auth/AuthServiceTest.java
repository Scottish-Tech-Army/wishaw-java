...
class AuthServiceTest {
    ...
    void register_success_withDefaultRole() {
        RegisterRequest request = new RegisterRequest("john", "pass123", "John Doe", null, null, null);
    ...
    void register_success_withCentreAndRole() {
        RegisterRequest request = new RegisterRequest("admin1", "pass123", "Admin", "CENTRE_ADMIN", 1L, null);
    ...
    void register_duplicateUsername_throws() {
        RegisterRequest request = new RegisterRequest("john", "pass123", "John", null, null, null);
    ...
    void register_centreNotFound_throws() {
        RegisterRequest request = new RegisterRequest("john", "pass123", "John", null, 999L, null);
        when(userRepository.existsByUsername("john")).thenReturn(false);
    ...
    void register_displaysNameDefaultsToUsername_whenNull() {
        RegisterRequest request = new RegisterRequest("john", "pass123", null, null, null, null);
        when(userRepository.existsByUsername("john")).thenReturn(false);
        when(passwordEncoder.encode("pass123")).thenReturn("encoded");
        when(userRepository.save(any(User.class))).thenAnswer(inv -> {
            User u = inv.getArgument(0);
