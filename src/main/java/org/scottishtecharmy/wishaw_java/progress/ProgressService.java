...
public class ProgressService {
    ...
    public BadgeProgressResponse completeSubBadge(Long userId, Long subBadgeId) {
        ...
        String level = levelService.calculateLevel(progress.getTotalPoints());
        List<BadgeProgressResponse.EarnedSubBadge> earned = subBadgeCompletionRepository
                ...
                .toList();
        return new BadgeProgressResponse(badge.getId(), badge.getName(), progress.getTotalPoints(), level, earned);
    }

    /**
     * Get full profile for a user: all badge progress + overall XP.
     */
